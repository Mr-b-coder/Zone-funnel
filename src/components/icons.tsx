...
export const OrderIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const SubscriptionIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
    <svg 
        className={className}
        fill="none" 
        viewBox="0 0 24 24" 
        ...
        strokeWidth={1.5}
    >
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-4.991-2.696a4.126 4.126 0 01-5.834 0M2.985 19.644L8.25 14.379a8.25 8.25 0 0111.667 0l5.265 5.265" />
    </svg>
);

export const InventoryIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
    <svg 
        className={className}
        fill="none" 
        viewBox="0 0 24 24" 
...
export const WarehouseIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
    <svg 
        className={className}
        fill="none" 
        viewBox="0 0 24 24" 
        ...
        strokeWidth={1.5}
    >
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h6.375a.75.75 0 01.75.75v10.5a.75.75 0 01-.75.75H9a.75.75 0 01-.75-.75V7.5a.75.75 0 01.75-.75z" />
    </svg>
);
...
export const YouTubeIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg fill="currentColor" viewBox="0 0 576 512" className={className}>
        <path d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zM232.615 352.708V159.292l157.75 96.708-157.75 96.708z" />
    </svg>
);
...
export const TikTokIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg fill="currentColor" viewBox="0 0 448 512" className={className}>
        <path d="M448 209.9a210.1 210.1 0 01-122.8-39.25V349.38A162.6 162.6 0 11185 188.31v89.81a74.6 74.6 0 1052.23 71.18V0h88.18a121.2 121.2 0 001.86 22.17A122.2 122.2 0 00381 102.39a121.4 121.4 0 0067 20.14z"/>
    </svg>
);
...
export const GlobeIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 2.25c5.385 0 9.75 4.365 9.75 9.75S17.385 21.75 12 21.75 2.25 17.385 2.25 12 6.615 2.25 12 2.25zM12 7.5v9m4.5-4.5H7.5m9-4.5a9.75 9.75 0 01-9-6m9 6a9.75 9.75 0 01-9-6m18 0a9.75 9.75 0 01-9-6m9 6a9.75 9.75 0 01-9-6" />
    </svg>
);  